...
<main class="manifestacao" class="container-fluid text-justify">
    ...
    <article class="row justify-content-center">
      <div class="manifestacao"  class="col-10 col-sm-12 col-md-10 col-lg-11">
        ...
        <div class="testando">
          ...
          <p>As manifestações são resultado de um processo de atrito entre o Executivo federal e as instituições de ensino superior que começou com o governo de Jair Bolsonaro. O presidente em Dallas classificou os manifestantes como "idiotas úteis". e; massa de manobra; .</p>
          <p>No DF, pelo menos seis mil pessoas marcharam para a Esplanada dos Ministérios. Em São Paulo (SP), milhares ocuparam a Avenida Paulista. No Rio de Janeiro, um grupo de pessoas caminha da Candelária até a região central do Brasil. A operação foi pacífica, mas, eventualmente, um grupo de homens mascarados entrou em confronto com a polícia. Os policiais militares responderam com bombas de gás.. </p>
        </div>
      </div>
    </article>
  </div>
  ...
  <div class="container">
    <article class="row justify-content-center">
      <div class="manifestacao" class="col-10 col-sm-12 col-md-10 col-lg-11">
        <h2 class="text-center mb-3 fontenegrito">Manifestações contra inflação e aumentos dos preços dos alimentos</h2>
        <div class="center">
        ...
        <p>Os temas mais comuns em cartazes e discursos foram a defesa da democracia, o impeachment e as críticas à forma como o governo federal lidou com a pandemia de COVID-19 e o aumento dos preços de alimentos, gás e combustíveis.
        </p>
        <p>Os eventos são organizados por movimentos sociais e centrais sindicais e contam com a participação de cerca de 20 partidos políticos, associações estudantis e até torcidas organizadas.
        </p>
      </div>
    </article>
  </div>
  ...
  <div class="container">
    <article class="row justify-content-center">
      <div class="manifestacao" class="col-10 col-sm-12 col-md-10 col-lg-11">
        ...
        <p>Mas, depois disso, no segundo dia do festival, artistas como Emicida, Silva e o cantor Jão também aproveitaram o momento para promover campanha pelo voto jovem, incentivando adolescentes a tirarem seu título de eleitor: “1º, boa noite! 2º, estava com a maior saudade; 3º, se você tem de 16 a 18 anos tire seu título de eleitor e 4º, Bolsonaro vai tomar no cu”, disse Emicida ainda no início do seu show. A fala foi seguida de gritos do público. </p>
      </div>
    </article>
  </div>
