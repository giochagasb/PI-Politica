...
<main class="container-fluid text-justify">
  <!--container1-->
  <div class="container">
    <article class="row mb-3 py-4 justify-content-center">
      <div class="col-10 col-sm-12 col-md-10 col-lg-11">
        <h2 class="text-center mb-3 fontenegrito">O QUE É CIDADANIA?</h2>
        <p class="fontteste">Cidadania é tudo aquilo que faz de uma pessoa um cidadão ou integrante pleno de um Estado, isto é, seus direitos e deveres. São justamente esses direitos que permitem aos cidadãos intervir nas ações do Estado e poder usufruir os serviços ofertados por órgãos estatais. Para exercer plenamente a cidadania, o Estado precisa assegurar a liberdade e acesso aos direitos individuais. A cidadania plena é comprometida em muitas nações por causa de questões econômicas e políticas.</p>
  ...
  <div class="container">
    <div class="row mb-3 py-4 align-items-center justify-content-center">
      <article class="col-10 col-sm-12 col-md-10 col-lg-6 order-lg-1">
        <h2 class="text-center mb-3 fontenegrito">CIDADANIA FORMAL</h2>
      ...
      <aside class="col-10 col-sm-10 col-md-10 col-lg-6 order-lg-1">
        <h2 class="text-center mb-3 fontenegrito">CIDADANIA E AS ELEIÇÕES</h2>
