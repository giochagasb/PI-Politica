...
<html lang="pt-BR">
    <head>
        ...
        <title>Projeto Intergador 2 Semestre</title>
    </head>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark">
            <div class="container-fluid">
                ...
                <div class="navbar-nav">
                    ...
                    <a class="nav-link" href="manifestacao.php">Manifestações</a>
            ...
            <div class="btn-group">
              <button type="button" class="btn btn-secondary dropdown-toggle" id="dropdownMenuButton2" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false">
                Partidos
              </button>
